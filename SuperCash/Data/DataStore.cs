...
public static class DataStore
{
    ...
    public static void InicializarDatos()
    {
        if (Usuarios.Count == 0)
        {
            Usuarios.Add(new Usuario { Id = 1, Nombre = "Admin", Apellido = "Super", Email = "admin@supercash.com", Contrasena = "admin123", Rol = "Administrador" });
            Usuarios.Add(new Usuario { Id = 2, Nombre = "Vendedor", Apellido = "User", Email = "vendedor@supercash.com", Contrasena = "vende123", Rol = "Vendedor" });
        }
        ...
        if (Productos.Count == 0)
        {
            ...
            Productos.Add(new Producto { Id = 3, Nombre = "Pan", Categoria = "Panadería", Precio = 0.90m, Cantidad = 5 }); // Stock bajo
        }
    }
}